	...
	class Sample_Plugin_Post {
		...
		*/
		private function page_render() {
			...
			$html .= '<td>';
			$html .= '<img src="' . plugins_url('../images/no-image.png', __FILE__) . '" width="200" height="">';
			...
			$html .= '<tr>';
			$html .= '<th>ID名</th>';
			$html .= '<td><input type="text" class="large-text" name="sample-element-id">';
			...
			$html .= '<th>表示方法(必須)</th>';
			$html .= '<td>';
			$html .= '<input type="radio" name="sample-how-display">下記の下に表示<br>';
